...
namespace ClementTodd.NodeEvents.Dialogue
{
    public class DialogueGUI : MonoBehaviour
    {
        ...
        {
            public TextAnimationStyle animationStyle;
        ...
        private void OnEnable()
        {
            ...
            {
                NodeEventManager.Instance.OnEventEnded += HideAll;
            }
        }
        ...
        public bool TryAdvanceText()
        {
            ...
            {
                // Stop if the "END OF TEXT" unicode character is found.
                if (dialogueBoxLabel.textInfo.characterInfo[textIndex].character == '\u0003')
                    break;
                ...
                while (dialogueBoxLabel.textInfo.characterInfo[textIndex].character != dialogueBoxLabel.text[richTextIndex])
                {
                    richTextIndex++;
                }
            }
            ...
            if (richTextIndex < dialogueBoxLabel.text.Length)
            {
                ...
                // Show the next part of the text
                ShowDialogueBox();
                StartTypewriterAnimation();
        ...
        private void InitCharacterAnimationDataFromText(string sourceText)
        {
            ...
            TextAnimationStyle animationStyle = null;
        ...
        public bool TrySkipTypewriterAnimation()
        {
            if (typewriterInProgress)
            {
                ...
                for (int i = 0; i < dialogueBoxLabel.textInfo.characterCount && dialogueBoxLabel.textInfo.characterInfo[i].character != '\u0003' && i < textAnimationData.Count; i++)
                {
                    TextAnimationData data = textAnimationData[i];
                    data.fadeInDelay = 0f;
                    textAnimationData[i] = data;
